 ...
 */
public class Bilan_T extends javax.swing.JFrame {

    ResultSet rslt = null;
    BDD base_donne;
    
    public Bilan_T() throws ClassNotFoundException, SQLException {
        initComponents();
...
"GROUP BY date";
    ...
    private void recher_par_moiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recher_par_moiActionPerformed
        try {                                               
            ...
            Logger.getLogger(Bilan_T.class.getName()).log(Level.SEVERE, null, ex);
...
document.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bilan_T.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
