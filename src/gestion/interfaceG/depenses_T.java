 ...
 */
public class depenses_T extends javax.swing.JFrame {
    ...
    public depenses_T() throws ClassNotFoundException, SQLException {
        initComponents();
...
public void date_set() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(retour);
        retour.setBounds(490, 240, 130, 50);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(0, 250, 1440, 370);
        ...
        if (libele_field.getText().equals("")|| montant_field.getText().equals("")){
            ...
            if(JOptionPane.showConfirmDialog(this,"êtes-vous Sûr d'avoir depenser cet argent","warning",JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION){
                try {
                    ...
                    Logger.getLogger(depenses_T.class.getName()).log(Level.SEVERE, null, ex);
...
document.close();
    ...
    private void retourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retourActionPerformed
        // TODO add your handling code here:
         DIG_T n= new DIG_T();n.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(depenses_T.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new depenses_T().setVisible(true);
