 ...
 */
public class Produit_T extends javax.swing.JFrame {
    ResultSet rslt=null;
    BDD base_donne;
    public Produit_T() throws SQLException, ClassNotFoundException {
    ...
    String[] colonnes = {"id","code_produit","ref","designation","fournisseur","remise","prix_unitaire","devise","stock","unite_mesure","DATE_FORMAT(date, '%Y-%m-%d')"};
...
public void ChampsActual(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(ActualiserBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, 150, 55));
    ...
    private void ActualiserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActualiserBtnActionPerformed
        try {
            ...
            Logger.getLogger(Produit_T.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Produit_T.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
